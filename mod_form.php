...
/**
 * The main mod_blending configuration form.
 *
 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_blending_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('blendingname', 'mod_blending'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'blendingname', 'mod_blending');
